...
class FCN(object):
    ...
    def __init__(self, sizes, _biases, _weights,cost=CrossEntropyCost):
        self.sizes = sizes
        self.cost = cost
    ...
    def SGD(self, training_data, epochs, mini_batch_size, eta, lmbda=0.0, test_data=None):
        ...
        for j in range(epochs):
            ...
            cost =0.1* self.total_cost(training_data, lmbda)
...
if __name__ == "__main__":
    ...
    # 这里的参数可以根据实际情况进行修改
    fc.SGD(training_data, 100, 20, 3.0, test_data=test_data)
'''
